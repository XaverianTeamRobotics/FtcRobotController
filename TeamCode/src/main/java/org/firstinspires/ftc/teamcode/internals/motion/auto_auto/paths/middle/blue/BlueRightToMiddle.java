...
public class BlueRightToMiddle extends AutoAutoPathSegment {
    ...
    public TrajectorySequenceBuilder addPathSegment(TrajectorySequenceBuilder builder) {
        return builder
                ...
                .splineToSplineHeading(new Pose2d(-58.77, 14.39, Math.toRadians(-90.00)), Math.toRadians(-90.00))
                .splineToSplineHeading(new Pose2d(-48.26, 12.00, Math.toRadians(0.00)), Math.toRadians(0.00))
